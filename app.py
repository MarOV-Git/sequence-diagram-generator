...
with colL:
    ...
    b1, b2, b3 = st.columns([0.45, 0.40, 0.15])
    with b1:
    ...
    st.info(
        ...
        "- Use toolbar **Export XML** (inside the viewer) to export after dragging/editing.\n"
        "- **Export XML (source)** above exports the original textarea XML.\n"
    )
